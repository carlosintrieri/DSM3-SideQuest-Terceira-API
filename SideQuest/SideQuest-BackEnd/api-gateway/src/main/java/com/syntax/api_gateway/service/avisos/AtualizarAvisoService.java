...
/**
 * Service responsável por atualizar avisos no Avisos Service
 */
@Service
public class AtualizarAvisoService {
    ...
    /**
     * Realiza requisição PATCH para atualizar aviso
     */
    public Mono<ResponseEntity<Object>> atualizar(String path, HttpServletRequest request) {
